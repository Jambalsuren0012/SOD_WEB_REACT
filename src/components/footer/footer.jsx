...
const Footer = () => {
  return (
    <footer class="bg-sky-800 text-center text-neutral-600 dark:bg-sky-800 dark:text-neutral-200 lg:text-left">
      <div class="max-w-screen-xl m-auto">
        <div class="flex items-center   justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
          <div class="mr-12  flex items-center">
            <img className="h-24 w-24" src="../../images/sod logo.png" alt="" />
            <span>SOD ELECTRONIC</span>
          </div>
        ...
        <div class="mx-6 py-10 text-center md:text-left">
          <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="">
              ...
              <p class="mb-4">
                <a href="/home" class="text-neutral-600 dark:text-neutral-200">
                  Home
                </a>
              </p>
              <p class="mb-4">
            ...
            <div>
              ...
              <p class="mb-4 flex items-center justify-center md:justify-start">
                ...
                Баянзүрх 4 хороо американ дэнж
              </p>
              <p class="mb-4 flex items-center justify-center md:justify-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
